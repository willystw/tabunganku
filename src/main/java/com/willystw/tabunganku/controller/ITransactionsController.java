...
public interface ITransactionsController {
  ...
  GetTransactionListResponse getTransactions(long userId, LocalDate transactionDate);
  ...
  GetTransactionSummaryResponse getSummary(long userId, LocalDate transactionDate);
}
