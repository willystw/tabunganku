...
public interface ICategoriesController {
  ...
  @Operation(
      ...
      description = "Add a new category. The request must provide  category_name"
          + ", transaction_type",
  ...
  AddCategoryResponse insertNewCategory(@Valid AddCategoryRequest request);
  ...
  GetCategoryListResponse getCategoryListByUserId();

  @Operation(
      summary = "Retrieve a category by Id",
      description = "Get a category by specifying its ID. The response is a Category object"
  ...
  GetCategoryDetailResponse getCategoryDetail(Long categoryId);
